...
const models = {
    ...
    SalonPlan: require('../features/SalonPlan/salon_plan.model').SalonPlan,
    SalonPlanSubscription: require('../features/SalonPlan/salon_plan.model').SalonPlanSubscription,
    Unit: require('./Unit'),
...
Client.belongsTo(MonthlyPackage, { foreignKey: 'package_id', as: 'package' });
Client.belongsTo(SalonPlan, { foreignKey: 'plan_id', as: 'salon_plan' });
...
Appointment.belongsTo(SalonPlanSubscription, { foreignKey: 'salon_plan_subscription_id', as: 'salon_plan_subscription' });
SalonPlanSubscription.hasMany(Appointment, { foreignKey: 'salon_plan_subscription_id' });
